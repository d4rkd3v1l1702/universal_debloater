...
# Check if the de-bloat file exists for the selected device
...
# Read the de-bloat file line by line and remove packages
while IFS= read -r package_name; do
    echo "Removing package: ./adb shell pm uninstall -k --user 0 $package_name"
    # Use the appropriate command to uninstall the package on your mobile device
